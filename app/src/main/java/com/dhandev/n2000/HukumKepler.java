...
public class HukumKepler extends AppCompatActivity {
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_hukum_kepler );
        ...
        btnr1.setOnClickListener ( new View.OnClickListener ( ) {
            ...
            public void onClick ( View view ) {
               ...
               R2R2 = Double.parseDouble ( R2.getText ( ).toString ( ) );
                ...
                R1R1 = R1R1 * R2R2;
                tampilan3.setText ( " R1 = " + df.format ( R1R1 ) + " km" );
        ...
        btnr2.setOnClickListener ( new View.OnClickListener ( ) {
            ...
            public void onClick ( View view ) {
                ...
                R2R2= R1R1 * R2R2;
                tampilan3.setText ( " R2 = " + df.format ( R2R2 ) + " km" );
            }}  );
        ...
        btnvar.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick ( View view ) {
                Intent intent = new Intent ( HukumKepler.this , HukumKepplerVar.class );
